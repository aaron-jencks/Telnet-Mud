...
func transitionToArr(rs map[string]interface{}) []interface{} {
  ...
  return []interface{}{
    ...
    rs["Command"],
    command_service.FormatRegexFromArr(sargs),
  }
}
...
func transitionFromArr(arr []interface{}) interface{} {
  return ExpandedTransition{
    ...
    arr[3].(int),
    arr[4].(string),
    command_service.FormatRegexToArr(arr[5].(string)),
  }
}
...
func createTransitionFunc(table *db.TableDefinition, args ...interface{}) []interface{} {
  ...
  return []interface{}{id, args[0], args[1], args[2], command_service.FormatRegexFromArr(args[3].([]string))}
}
